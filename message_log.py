...
class MessageLog:
    ...
    def add_message(
        ...
        *,
        ...
        if 'stack' is True then the message can stack with previous message
        or the same text.
        """
    ...
    def render(
        ...
        'x', 'y', 'width', 'height' is the rectangular region to
        render onto the 'console'
        """
